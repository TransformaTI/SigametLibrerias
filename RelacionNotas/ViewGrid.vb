...
#Region "Global variables"
    ...
    Private _PrevSelectedItem As ListViewItem
    Private _PrevBackColor As Color
    Private _SelectionBackColor As Color = Color.DarkBlue
    Private _SelectionForeColor As Color = Color.White
#End Region
...
#Region "Properties"
    ...
    Property AlternativeBackColor() As Color
        ...
        End Set
    End Property
    <Description("The back color of the selected item"), Category("Appearance")> _
    Property SelectionBackColor() As Color
        ...
        Set(ByVal Value As Color)
            ...
            ChangeSelectedItemColors()
        End Set
    End Property
    <Description("The font color of the selected item"), Category("Appearance")> _
...
#End Region
    ...
    Private Sub ViewGrid_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.SelectedIndexChanged
        If Not _PrevSelectedItem Is Nothing Then
            Dim sitm As ListViewItem.ListViewSubItem
            For Each sitm In _PrevSelectedItem.SubItems
                sitm.BackColor = _PrevBackColor
                sitm.ForeColor = Me.ForeColor
            Next
        End If
        ChangeSelectedItemColors()
    End Sub
    Private Sub ChangeSelectedItemColors()
        If Me.SelectedItems.Count > 0 Then
            Dim sitm As ListViewItem.ListViewSubItem
            _PrevSelectedItem = Me.SelectedItems(0)
            _PrevBackColor = Me.SelectedItems(0).BackColor

            For Each sitm In Me.SelectedItems(0).SubItems
                sitm.BackColor = _SelectionBackColor
                sitm.ForeColor = _SelectionForeColor
            Next
        End If
    End Sub
