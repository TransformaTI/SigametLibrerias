...
Public Class captLecturaCambioMedidor
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents txtLecturaIni As System.Windows.Forms.TextBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtLecturaIni = New System.Windows.Forms.TextBox()
        ...
        'txtLecturaIni
        '
        Me.txtLecturaIni.AutoSize = False
        ...
        Me.txtRedondeo.TabIndex = 17
        Me.txtRedondeo.TabStop = False
        Me.txtRedondeo.Text = "Total $"
        Me.txtRedondeo.TextAlign = System.Windows.Forms.HorizontalAlignment.Right
        '
        'captLecturaCambioMedidor
        '
        Me.BackColor = System.Drawing.Color.WhiteSmoke
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.txtRedondeo, Me.txtLecturaIni, Me.txtTotal, Me.txtIVA, Me.txtLecturaFin, Me.txtDiferencia, Me.txtNumInterior, Me.txtImpConsumo, Me.txtConsumoLts, Me.txtFLecturaFin, Me.txtFLecturaIni, Me.txtClienteNum})
        Me.Name = "captLecturaCambioMedidor"
...
#End Region
    ...
    Dim _precioPorLitro As Decimal
    '01/02/2006 redondeo de lecturas
    Dim _redondeoPorAplicar As Decimal
    Dim _redondeo As Decimal
    Private _redondeoActivo As Boolean
    '***
    ...
    Public Shadows Event validating()
    ...
    Public ReadOnly Property Redondeo() As Decimal
        Get
            Return _redondeo
        End Get
    End Property
    ...
    Private Sub txtLecturaFin_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtLecturaFin.Validating
    ...
    Private Sub calculaImporte(ByVal LecturaFinal As Decimal, ByVal LecturaInicial As Decimal)
        Dim diferencia, consumoLts, total, importe, impuesto, _
            internalFact, internalPrecio, internalImpuesto As Decimal
        diferencia = LecturaFinal - LecturaInicial
        internalFact = _factorDeConversion
        internalPrecio = _precioPorLitro
        internalImpuesto = _impuesto
        ...
        If internalImpuesto > 1 Then
            internalImpuesto = internalImpuesto / 100
        End If
        consumoLts = diferencia * internalFact
        total = consumoLts * internalPrecio
        ...
        importe = total / (internalImpuesto + 1)
    ...
    Private Sub txtLecturaIni_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    '        txtTotal.Text = "0"
    '    End If
    '    Dim lectFinal, lectInicial, diferencia, consumoLts, total, importe, impuesto As Double
    '    total = CDbl(txtTotal.Text)
    '    lectFinal = CDbl(txtLecturaFin.Text)
    ...
    Private Sub txtNumeroDecimal_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtLecturaIni.KeyPress
        If Char.IsDigit(e.KeyChar) Or e.KeyChar = "." Or e.KeyChar = "-" Or Asc(e.KeyChar) = 8 Then
            e.Handled = False
        Else
            e.Handled = True
        End If
    ...
    Private Sub txtNumeroDecimal_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtLecturaIni.Enter
        txtFLecturaIni.SelectAll()
    End Sub

    Private Sub txtNumeroDecimal_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtLecturaIni.Validated
        If txtLecturaIni.Text = "-" Then
            txtLecturaIni.Text = "0"
        End If
    End Sub
