...
{
	/// <summary>
	/// Summary description for frmBaucher.
	/// </summary>
	public class frmBaucher : System.Windows.Forms.Form
	{
		...
		public frmBaucher(int Cliente,string PedidoReferencia)
		{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmBaucher));
			...
			this.Name = "frmBaucher";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Llena Voucher";
			this.Load += new System.EventHandler(this.frmBaucher_Load);
...
//				LiquidacionSTN.Modulo.CnnSigamet.Dispose ();
		...
		private void frmBaucher_Load(object sender, System.EventArgs e)
		{
