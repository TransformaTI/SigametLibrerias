    ...
    public partial class ConsultaDatos : Consulta
    {
            ...
            string Usuario, string Referencia, int? IDAutotanque = null, DateTime? FechaConsulta = null)
        {
            ...
            try
            {
                ...
                #endregion
                reader = datos.Data.LoadData("spSCBusquedaClientes", CommandType.StoredProcedure, listParams.ToArray());
                ...
                System.Threading.Tasks.Parallel.ForEach(lstLlaves, s => direccionesEntrega.Add(new DireccionEntregaCreator().FactoryMethod(IDEmpresa, s, Usuario, Fuente.Sigamet)));
