<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DesgloseConceptoBusca.aspx.vb" Inherits="SigametFinancieroTesoreria.DesgloseConceptoBusca" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Sigamet Financiero Tesoreria Corporativa - Reporte de Ingresos Busqueda 
			Cheque</title>
				...
				<TBODY>
					...
					<TR>
						<TD class="TablaFondo" style="HEIGHT: 135px"><label class="texto" id="Empresa" style="FONT-SIZE: 8pt; Z-INDEX: 100; LEFT: 19px; WIDTH: 45px; FONT-FAMILY: Tahoma; POSITION: absolute; TOP: 60px; HEIGHT: 13px">Empresa</label>
							...
							<input class="BoxDos" onkeypress="fnCaracterEspecial()" id="Cheque" onkeydown="fnEnter()" onblur="fnStyleblur(this)" style="FONT-SIZE: 8pt; Z-INDEX: 97; LEFT: 446px; WIDTH: 151px; FONT-FAMILY: Tahoma; POSITION: absolute; TOP: 106px; HEIGHT: 18px; TEXT-ALIGN: left" onfocus="fnStylefocus(this)" tabIndex="8" type="text" maxLength="30" align="left" size="37" name="Cheque" runat="server">
							<input class="BoxDos" onkeypress="fnNumeroDecimal(this)" id="Monto" onkeydown="fnEnter()" onblur="fnStyleblur(this)" style="FONT-SIZE: 8pt; Z-INDEX: 96; LEFT: 446px; WIDTH: 151px; FONT-FAMILY: Tahoma; POSITION: absolute; TOP: 130px; HEIGHT: 18px; TEXT-ALIGN: right" onfocus="fnStylefocus(this)" tabIndex="9" type="text" maxLength="14" align="right" size="37" name="Monto" runat="server">
					...
					<tr>
						<td class="TablaFondo" vAlign="top" noWrap align="middle">
							<DIV class="TablaFondo" id="DIV1" style="OVERFLOW: auto; WIDTH: 733px; HEIGHT: 406px" tabIndex="7" runat="server">
								<asp:datagrid id="dgrConsulta" tabIndex="12" runat="server" CssClass="formobj" Height="25px" Width="1000px" BorderStyle="Solid" BorderColor="LightSteelBlue" CellPadding="0" PageSize="1">
