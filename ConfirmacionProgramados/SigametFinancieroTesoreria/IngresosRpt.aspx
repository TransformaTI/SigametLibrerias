<%@ Page Language="vb" AutoEventWireup="false" Codebehind="IngresosRpt.aspx.vb" Inherits="SigametFinancieroTesoreria.IngresosRpt" %>
...
<HTML>
	...
	<body class="FondoPage" onload="window.status='Sigamet Financiero Tesoreria Corporativa Version 1.0.0.0'" MS_POSITIONING="GridLayout">
		<form id="Form1" style="Z-INDEX: 101; LEFT: 25px; WIDTH: 397px; POSITION: absolute; TOP: 145px; HEIGHT: 684px" method="post" runat="server">
			<TABLE class="TablaBorderp" id="Table1" style="Z-INDEX: 101" height="630" cellSpacing="0" cellPadding="0" width="670" runat="server">
				<TBODY>
					<tr>
					...
					<TR>
						<TD class="TablaFondo" style="HEIGHT: 128px"><label class="texto" id="Empresa" style="FONT-SIZE: 8pt; LEFT: 12px; WIDTH: 45px; FONT-FAMILY: Tahoma; POSITION: absolute; TOP: 57px; HEIGHT: 13px">Empresa</label>
							<label class="texto" id="FechaInicio" style="FONT-SIZE: 8pt; LEFT: 319px; WIDTH: 64px; FONT-FAMILY: Tahoma; POSITION: absolute; TOP: 58px; HEIGHT: 16px" runat="server">
								...
								Caja</label>&nbsp;<BUTTON class="button" id="btnSalir" style="BORDER-RIGHT: midnightblue 1px solid; PADDING-RIGHT: 1px; BORDER-TOP: midnightblue 1px solid; PADDING-LEFT: 1px; LEFT: 566px; PADDING-BOTTOM: 1px; BORDER-LEFT: midnightblue 1px solid; WIDTH: 85px; CURSOR: hand; PADDING-TOP: 1px; BORDER-BOTTOM: midnightblue 1px solid; POSITION: absolute; TOP: 133px; HEIGHT: 22px" accessKey="S" tabIndex="8" type="button" runat="server">Salir</BUTTON>&nbsp;&nbsp;<BUTTON class="button" id="btnConsultar" style="BORDER-RIGHT: midnightblue 1px solid; PADDING-RIGHT: 1px; BORDER-TOP: midnightblue 1px solid; PADDING-LEFT: 1px; LEFT: 566px; PADDING-BOTTOM: 1px; BORDER-LEFT: midnightblue 1px solid; WIDTH: 85px; CURSOR: hand; PADDING-TOP: 1px; BORDER-BOTTOM: midnightblue 1px solid; POSITION: absolute; TOP: 54px; HEIGHT: 22px" accessKey="C" tabIndex="5" type="button" runat="server">Consultar</BUTTON><BUTTON class="button" id="btnExportar" style="BORDER-RIGHT: midnightblue 1px solid; PADDING-RIGHT: 1px; BORDER-TOP: midnightblue 1px solid; PADDING-LEFT: 1px; LEFT: 566px; PADDING-BOTTOM: 1px; BORDER-LEFT: midnightblue 1px solid; WIDTH: 85px; CURSOR: hand; PADDING-TOP: 1px; BORDER-BOTTOM: midnightblue 1px solid; POSITION: absolute; TOP: 80px; HEIGHT: 22px" accessKey="E" tabIndex="7" type="button" runat="server">Exportar</BUTTON><BUTTON class="button" id="btnImprimir" style="BORDER-RIGHT: midnightblue 1px solid; PADDING-RIGHT: 1px; BORDER-TOP: midnightblue 1px solid; PADDING-LEFT: 1px; LEFT: 566px; PADDING-BOTTOM: 1px; BORDER-LEFT: midnightblue 1px solid; WIDTH: 85px; CURSOR: hand; PADDING-TOP: 1px; BORDER-BOTTOM: midnightblue 1px solid; POSITION: absolute; TOP: 106px; HEIGHT: 22px" accessKey="I" tabIndex="6" type="button" runat="server">Imprimir</BUTTON>
							<BR>
							&nbsp;&nbsp;&nbsp;
					...
					<tr>
						<td class="TablaFondo" vAlign="top" noWrap align="middle">
							<DIV class="TablaFondo" id="DIV1" style="OVERFLOW: auto; WIDTH: 480px; HEIGHT: 402px" tabIndex="7" runat="server">
									...
									<ITEMTEMPLATE>
										<tr height="18px" style="FONT-SIZE: 8pt; FONT-FAMILY: Tahoma; ">
											<td align="left" style="FONT-SIZE: 8pt; COLOR: #000099; FONT-FAMILY: Tahoma; BACKGROUND-COLOR: inactivecaptiontext">
												<asp:label Width=250px id='Descripcion' runat="server" text='<%# DataBinder.Eval(Container.DataItem, "Movimiento") %>'/></td>
											<td align="right" style="FONT-SIZE: 8pt; COLOR: #000099; FONT-FAMILY: Tahoma; BACKGROUND-COLOR: Honeydew">
												<asp:label Width=100px id="Kilos" runat="server" text='<%# DataBinder.Eval(Container.DataItem, "Kilos") %>'/></td>
											<td align="right" style="FONT-SIZE: 8pt; COLOR: #000099; FONT-FAMILY: Tahoma; BACKGROUND-COLOR: PeachPuff">
												<asp:label Width=100px id="Monto" runat="server" text='<%# DataBinder.Eval(Container.DataItem, "Monto") %>'/></td>
										</tr>
									</ITEMTEMPLATE>
									<HEADERTEMPLATE>
										<table align="center" id="Header" border="1" cellpadding="0" cellspacing="1">
											<tr height="18px" style="FONT-SIZE: 8pt; FONT-FAMILY: Tahoma; ">
												<td align="center" class="colortd" width="250">DESCRIPCION</td>
