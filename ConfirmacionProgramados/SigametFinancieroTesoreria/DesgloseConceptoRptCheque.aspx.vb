'Objetivo: Permitir consultar y exportar la relación cheques
'Desarrollada por: Norma Patricia Munoz Solis
'Fecha: 02-May-2005
'Modificado por:
'Fecha Modificación:

Partial Class DesgloseConceptoRptCheque
...
#End Region
    ...
    Private Sub ShowDatagrid()
        Try
            Message("")
            Dim ds As DataSet = ExeQuery("SP_RPT_INGRESOS_DESGLOSECONCEPTO_BANCO " & IIf(ddlEmpresaContable.SelectedItem.Text = "Todas", "NULL", "'" & ddlEmpresaContable.SelectedItem.Value & "'") & _
                                        ...
                                        ",'" & CalendarFInicio.SelectedDate.ToString & "','" & CalendarFFin.SelectedDate.ToString & "'")
    ...
    Public Sub dgrConsulta_ItemDataBound(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgrConsulta.ItemDataBound
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            If e.Item.Cells(2).Text.IndexOf("SUBTOTAL") <> -1 Then
                e.Item.Cells(2).BackColor = Color.Beige
                ...
                e.Item.Cells(2).Font.Size.Point(14)
                e.Item.Cells(3).Font.Size.Point(14)
                e.Item.Cells(2).HorizontalAlign = HorizontalAlign.Right
            End If

            If e.Item.Cells(2).Text.IndexOf("TOTAL") <> -1 Then
            ...
            If e.Item.Cells(2).Text.IndexOf("RELACION") <> -1 Then
                e.Item.Cells(0).BackColor = Color.Navy
                e.Item.Cells(1).BackColor = Color.Navy
                e.Item.Cells(2).BackColor = Color.Navy
                e.Item.Cells(3).BackColor = Color.Navy
                e.Item.Cells(4).BackColor = Color.Navy
                e.Item.Cells(2).Font.Bold = True
                e.Item.Cells(2).Font.Size.Point(18)
                e.Item.Cells(2).ForeColor = Color.White
            End If

            If Trim(e.Item.Cells(0).Text) = "NUM. CHEQUE" Then
            ...
            If Trim(e.Item.Cells(0).Text) & Trim(e.Item.Cells(1).Text) & Trim(e.Item.Cells(2).Text) & Trim(e.Item.Cells(3).Text) = "" Then
                e.Item.Cells(4).Font.Bold = True
                e.Item.Cells(4).Font.Size.Point(14)
            End If
    ...
    Sub Exportacion()
        ...
        Dim Encabezado As String = "<div align='left'>" & _
                                        ...
                                        "Reporte Ingresos - Relacion Cheques" & "</Font><br><br>" & _
