'Objetivo: Permitir consultar, imprimir y exportar el desglose de los conceptos de ingresos
...
Partial Class DesgloseConceptoRpt
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If Trim(Session("IdSession")) <> "" Then
            If Not IsPostBack Then
                ...
                LlenaCombo("SP_DATOSCOMBO 'CONCEPTO',0,0,'','',''", ddlConcepto, True)
            End If
        Else
    ...
    Private Sub ShowDatagrid()
        Try
            Message("")
            Dim ds As DataSet = ExeQuery("SP_RPT_INGRESOS_DESGLOSECONCEPTO '" & ddlFechaInicio.SelectedItem.Value & _
                                        ...
                                        "," & IIf(ddlConcepto.SelectedItem.Text = "Todas", "NULL", ddlConcepto.SelectedItem.Value) & _
                                        "," & IIf(chkVertical.Checked, "VERTICAL", "HORIZONTAL"))
    ...
    Public Sub dgrConsulta_ItemDataBound(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgrConsulta.ItemDataBound
        If chkVertical.Checked Then
            ...
            If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
                e.Item.Cells(3).BackColor = Color.PeachPuff
                e.Item.Cells(3).Text = Format(Val(e.Item.Cells(3).Text), "$ #,#.00")
                Dim MontoInteger As String = Mid(e.Item.Cells(3).Text, 1, Len(e.Item.Cells(3).Text) - 3)
                Dim MontoDecimal As String = Right(e.Item.Cells(3).Text, 3)
                If Left(MontoDecimal, 1) = "," Then
                    e.Item.Cells(3).Text = Replace(MontoInteger, ".", ",") & "." & Right(MontoDecimal, 2)
                End If
        ...
        Else
            ...
            If e.Item.ItemType = ListItemType.Header Then
                For i = 1 To e.Item.Cells.Count - 1
                    ...
                    If Left(e.Item.Cells(i).Text, 1) = "C" Then
                        e.Item.Cells(i).Text = ""
                    End If
                Next
            End If
            ...
            If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
                ...
                For i = 1 To e.Item.Cells.Count - 1
                    ...
                    Col = j * 3
                    If e.Item.Cells.Count > Col Then
                        If e.Item.Cells(Col).Text <> "&nbsp;" Then
                            e.Item.Cells(Col).BackColor = Color.PeachPuff
                            e.Item.Cells(Col).Text = Format(Val(e.Item.Cells(Col).Text), "$ #,#.00")
                            Dim MontoInteger As String = Mid(e.Item.Cells(Col).Text, 1, Len(e.Item.Cells(Col).Text) - 3)
                            Dim MontoDecimal As String = Right(e.Item.Cells(Col).Text, 3)
                            If Left(MontoDecimal, 1) = "," Then
                                e.Item.Cells(Col).Text = Replace(MontoInteger, ".", ",") & "." & Right(MontoDecimal, 2)
                            End If
                        End If
                        e.Item.Cells(Col).HorizontalAlign = HorizontalAlign.Right
                        j = j + 1
                    End If
                Next
            End If
    ...
    Sub Exportacion()
        ...
        Dim Encabezado As String = "<div align='left'>" & _
                                        ...
                                        "Reporte Ingresos - Desglose Concepto" & "</Font><br><br>" & _
                                        ...
                                        "<Font style='FONT-WEIGHT: normal; FONT-SIZE: 11px; COLOR: navy; FONT-FAMILY: Tahoma; TEXT-ALIGN: left'>" & _
                                        "Concepto (s): " & ddlConcepto.SelectedItem.Text & "</Font><br>" & _
                                        "<Font style='FONT-WEIGHT: normal; FONT-SIZE: 11px; COLOR: navy; FONT-FAMILY: Tahoma; TEXT-ALIGN: left'>" & _
    ...
    Private Sub ddlConcepto_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ddlConcepto.SelectedIndexChanged
        Message("")
    End Sub
End Class
