...
#Region "Carga por direccion de entrega"

	Public Sub CargaPorDireccionDeEntrega(ByVal objPedido As RTGMCore.Pedido)

		Try
			Me.lblCalle.Text = objPedido.DireccionEntrega.CalleNombre
			Me.lblColonia.Text = objPedido.DireccionEntrega.ColoniaNombre
			Me.lblCP.Text = objPedido.DireccionEntrega.CP
			Me.lblEntreCalle1.Text = objPedido.DireccionEntrega.EntreCalle1Nombre
			Me.lblEntreCalle2.Text = objPedido.DireccionEntrega.EntreCalle2Nombre
			Me.lblMunicipio.Text = objPedido.DireccionEntrega.MunicipioNombre
			Me.lblNumExterior.Text = objPedido.DireccionEntrega.NumExterior
			Me.lblNumInterior.Text = objPedido.DireccionEntrega.NumInterior
			Me._CP = Me.lblCP.Text
			txtCalle.Visible = False
			cboColonia.Visible = False
			txtCP.Visible = False
...
#End Region
	...
	Private Sub SeleccionCalleColonia_Load(sender As Object, e As EventArgs) Handles MyBase.Load
