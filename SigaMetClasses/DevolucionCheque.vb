    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        If ValidaCaptura() = True Then
            If MessageBox.Show("¿Están correctos los datos?", Titulo, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.Yes Then
                ...
                Try
                    _PedidoReferencia = oCobro.ChequeDevolucion(_AñoCobro, _Cobro, CType(ComboRazonDevCheque.SelectedValue, String), Trim(txtObservaciones.Text), dtpFDevolucion.Value.Date, chkComisionCheqDev.Checked, _
                        _DevolucionMultipleSeleccionada)
