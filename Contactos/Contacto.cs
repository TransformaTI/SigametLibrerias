...
namespace CRMContactos
{
    ...
    public class Contacto : System.Windows.Forms.Form
    {
		...
		private void InitializeComponent()
		{
			...
			this.label8.Text = "Correo Electr�nico:";
			// 
			...
			this.menuItem2.Text = "&Eliminar la relaci�n seleccionada";
		...
		{
			MessageBox.Show("La direcci�n de correo: " + ((EMail)sender).CorreoElectronico + (char)13 +
				"proporcionada no es v�lida", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);		
		}
