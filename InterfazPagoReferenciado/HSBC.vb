Module ModHSBC
    ...
    Public conexionHSBC As SqlClient.SqlConnection ' = New SqlClient.SqlConnection("Data Source = (Local); Integrated Security = SSPI; Initial Catalog = master")


    Public Function EsHSBC(ByVal Archivo As String, ByVal Cuenta As String)
    ...
    Private Function EncontrarCabeceraBancomer(ByVal NombreArchivo As String) As Integer
        ...
        Do While Not EOF(1)
            Linea = LineInput(1)
            If Linea = "Fecha	Descripción	Retiro	Depósito	Saldo" Then
                    ...
                    If Linea.Chars(0) <> Chr(9) Then
                        ...
                        If Len(Reg.Importe) <> 0 Then
                            ...
                            Catch ex As Exception
                                ...
                                MsgBox("Se encontró inconsistencia en la información favor de reportarlo. HSBC1", MsgBoxStyle.OkOnly Or MsgBoxStyle.Critical, "Error de integridad de datos")
    ...
    Private Function SepararColumnasBancomer(ByVal Linea As String, ByVal Indice As Integer, ByVal Separador As Integer) As Registro
        ...
        For i = 0 To Max - 1
            If Linea.Chars(i) <> Chr(Separador) Then
                ...
                If Comas = 3 Then
                    If Linea.Chars(i) <> Chr(34) And Linea.Chars(i) <> Chr(36) And Linea.Chars(i) <> Chr(160) Then
        ...
        For i = 0 To Len(DescripcionBBVA) - 1
            If DescripcionBBVA.Chars(i) = Chr(32) Then
                Diagonales += 1
            End If
        Next

        If Diagonales = 10 Then
            For i = 0 To Len(DescripcionBBVA) - 1
                If DescripcionBBVA.Chars(i) = Chr(32) Then
                    TestDiagonales += 1
                End If

                If TestDiagonales = 10 Then
    ...
    Private Function ObtenerBanco(ByVal Cuenta As String) As Integer
    ...
    Private Function ObtenerCuenta(ByVal Path As String) As String
    ...
    Private Function Deshacer(ByVal NombreArchivo As String)
        Dim Cnn As SqlClient.SqlConnection = conexionBBVA
        If Cnn.State = ConnectionState.Closed Then
            Cnn.Open()
        End If
    ...
    Private Function ValidarDatos(ByVal Fecha As Date, ByVal Referenencia As String, ByVal Importe As Double) As Integer
        ...
        Catch ex As System.FormatException When Not IsNumeric(Importe)
            MsgBox("Se encontró inconsistencia en la información favor de reportarlo. HSBC2", MsgBoxStyle.OkOnly Or MsgBoxStyle.Critical, "Error de integridad de datos")
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    ...
    Private Function ValidarArchivo(ByVal Nombre As String) As Integer
