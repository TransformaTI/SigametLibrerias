...
#Region "cLiquidacion"
    ...
    Public Class cLiquidacion
        ...
        Public Sub LiquidacionPedidoyCobroPedido(ByVal Producto As Integer, ByVal FPedido As DateTime,
            ...
            Try
                cmd = New SqlCommand("spPTLLiquidacionPedidoyCobroPedidoTRN", Connection) 'estespes la version anterior
                ...
                '  cmd.Parameters.Add("@SerieRemision", SqlDbType.VarChar).Value = SerieRemision
