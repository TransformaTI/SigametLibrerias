...
#Region "Class cMovimientoProductoItem"
	Public Class cMovimientoProductoItem
		Private _producto As Integer
		Private _cantidad As Integer
		Private _tipo As Integer
		Private _zonaEconomica As Short

		Public Sub New(_producto As Integer, _cantidad As Integer, _tipo As Integer, _zonaEconomica As Short)
			Me._producto = _producto
			Me._cantidad = _cantidad
			Me._tipo = _tipo
			Me._zonaEconomica = _zonaEconomica
		End Sub
		...
		Public Property ZonaEconomica As Short
			Get
...
#Region "Class cMovimientoProductoLista"
	Public Class cMovimientoProductoLista
		Public ReadOnly Property items As List(Of cMovimientoProductoItem)

		Public Sub New()
			items = New List(Of cMovimientoProductoItem)
		End Sub

		Public Sub agregaItem(_producto As Integer, _cantidad As Integer, _tipo As Integer, _zonaEconomica As Short)
			Dim indice As Integer = -1
			For i As Integer = 0 To items.Count - 1
				If items(i).Producto = _producto And items(i).Tipo = _tipo And items(i).ZonaEconomica = _zonaEconomica Then
					indice = i
					Exit For
				End If
			Next
			...
			If indice = -1 Then
				items.Add(New cMovimientoProductoItem(_producto, _cantidad, _tipo, _zonaEconomica))
			Else
				items(indice).Cantidad = items(indice).Cantidad + _cantidad
			End If
		End Sub
...
#Region "Clase CorteCaja"
	Public Class CorteCaja
		...
		Public Function Alta(ByVal Caja As Short,
			...
			Dim cmd As New SqlCommand("spCorteCajaAltaModifica", Connection)
			With cmd
...
#Region "cLiquidacion"
	...
	Public Class cLiquidacion
		...
		Sub New(ByVal shtConfiguracion As Short,
				ByVal datFAsignacion As Date,
		...
		'Constructor de la clase para inicializar algunas de sus propiedades
		Sub New(ByVal shtConfiguracion As Short,
				ByVal shtCelula As Short,
				ByVal shtAnoPedido As Short,
		...
		Public Sub ConsultaExistencia(ByVal Configuracion As Short,
...
#Region "MovimientoCaja"
	Public Class cMovimientoCaja
		...
		Public Sub AltaMovimientoCajaCobro(ByVal Caja As Short,
								  ByVal FOperacion As Date,
								  ByVal Consecutivo As Short,
								  ByVal Folio As Integer,
		...
		Public Sub AltaMovimientoCajaEntrada(ByVal Caja As Short,
							  ByVal FOperacion As Date,
							  ByVal Consecutivo As Short,
							  ByVal Folio As Integer,
							  ByVal AnoCobro As Short,
							  ByVal Cobro As Integer,
							  ByVal Denominacion As Short,
		...
		Public Sub AltaMovimientoCajaSalida(ByVal Caja As Short,
						  ByVal FOperacion As Date,
						  ByVal Consecutivo As Short,
						  ByVal Folio As Integer,
						  ByVal Denominacion As Short,
...
#Region "Class cMedicionFisicaAutomProducto"
	Public Class cMedicionFisicaAutomProducto
		...
		Public Sub New(ByVal shtConfiguracion As Short,
					   ByVal intMovimientoAlmacen As Integer,
					   ByVal intAlmacenGas As Short,
					   ByVal intCantidadFisica As Integer,
					   ByVal decKilosFisicos As Decimal,
					   ByVal decLitrosFisicos As Decimal,
					   ByVal decFactorDensidad As Decimal,
					   ByVal strUsuario As String,
					   ByVal intEmpeado As Integer,
					   ByVal dtpFHoraMedicion As DateTime,
		...
		Public Sub New(ByVal shtConfiguracion As Short,
					   ByVal intMovimientoAlmacen As Integer,
					   ByVal intAlmacenGas As Short,
					   ByVal intMedicionFisica As Integer,
